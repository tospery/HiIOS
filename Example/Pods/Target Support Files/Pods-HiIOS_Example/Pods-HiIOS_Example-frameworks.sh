...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HiIOS/HiIOS.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Kingfisher/Kingfisher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MJRefresh/MJRefresh.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Moya/Moya.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NSObject+Rx/NSObject_Rx.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ObjectMapper-Hi/ObjectMapper_Hi.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwifterSwift-Hi/SwifterSwift_Hi.framework"
