...
/// https://forums.swift.org/t/weak-linking-of-frameworks-with-greater-deployment-targets/26017/24
    ...
    /// `PageView` provides a SwiftUI wrapper around `OldPagingViewController`.
    ...
    public struct PageView<Item: PagingItem, Page: View>: View {
        ...
        final class CustomPagingViewController: OldPagingViewController {
            var items: [Item]?
        }
        ...
        final class Coordinator: PagingViewControllerDataSource, PagingViewControllerDelegate {
            ...
            func numberOfViewControllers(in _: OldPagingViewController) -> Int {
            ...
            func pagingViewController(_ controller: OldPagingViewController,
            ...
            func pagingViewController(_: OldPagingViewController,
            ...
            func pagingViewController(_: OldPagingViewController, didSelectItem pagingItem: PagingItem) {
