...
open class OldPagingViewController:
    UIViewController,
    ...
    /// setting the customization properties on `OldPagingViewController`.
    ...
    /// Creates an instance of `OldPagingViewController`. You need to call
    ...
    /// parameters are also available directly on `OldPagingViewController`.
    ...
    /// Creates an instance of `OldPagingViewController`. The first view
    ...
    /// Creates an instance of `OldPagingViewController`.
    ///
    ...
    /// initilize the `OldPagingViewController` to set the initial
...
extension OldPagingViewController: PagingMenuDataSource {
...
extension OldPagingViewController: PagingControllerSizeDelegate {
...
extension OldPagingViewController: PagingMenuDelegate {
