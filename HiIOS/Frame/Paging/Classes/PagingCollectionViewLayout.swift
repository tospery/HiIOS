...
/// is provided by customization properties on `OldPagingViewController`.
///
/// To create your own `PagingViewControllerLayout` you need to
/// override the `menuLayoutClass` property on `OldPagingViewController`.
...
open class PagingCollectionViewLayout: UICollectionViewLayout, PagingLayout {
    ...
    /// to the `OldPagingViewController`.
