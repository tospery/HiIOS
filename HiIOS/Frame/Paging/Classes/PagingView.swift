...
/// A custom `UIView` subclass used by `OldPagingViewController`,
...
/// `loadView:` in `OldPagingViewController` to use your subclass.
open class PagingView: UIView {
    ...
    public var options: PagingOptions {
        didSet {
            hConstraint?.constant = options.menuHeight
