...
public typealias BorderInsets = (CGFloat, CGFloat)

public struct BorderPosition: OptionSet, Hashable {
    ...
    public static let left   = BorderPosition(rawValue: 1 << 1)
    public static let bottom = BorderPosition(rawValue: 1 << 2)
    public static let right  = BorderPosition(rawValue: 1 << 3)
    public static let shadow = BorderPosition(rawValue: 1 << 4)
}

final public class BorderLayer: CALayer {

    public var borders: BorderPosition = [] {
        didSet {
    ...
    public var borderColors = [BorderPosition: UIColor]() {
        didSet {
            self.updateBordersColor()
        }
    }
    public var borderWidths = [BorderPosition: CGFloat]() {
        didSet {
            self.updateBordersFrame()
        }
    }
    public var borderInsets = [BorderPosition: BorderInsets]() {
        didSet {
            self.updateBordersFrame()
        }
    }
    ...
    // MARK: Utils
    func colorForBorder(_ border: BorderPosition) -> UIColor {
    ...
    func widthForBorder(_ border: BorderPosition) -> CGFloat {
    ...
    func insetsForBorder(_ border: BorderPosition) -> BorderInsets {
